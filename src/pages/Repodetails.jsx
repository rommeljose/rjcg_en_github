    ...
    return (
        <div id="repodetail">
            <div className="repodetail-card">
                ...
                <p>Live site: {deployment.length === 0 || deployment[0].original_environment !== "github-pages" ? `none` : <a href={`https://mbonamensa.github.io/${details.name}`}>mbonamensa.github.io/{details.name}</a>}</p>
